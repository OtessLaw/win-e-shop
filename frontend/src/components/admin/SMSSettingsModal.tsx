...
export const SMSSettingsModal: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  const saveMutation = useMutation({
    mutationFn: () => orderService.saveSMSSettings({ apiKey, senderId }),
    onSuccess: (data: any) => {
      ...
      <div className="bg-gray-950 border border-gold-500/30 w-full max-w-xl rounded-sm shadow-2xl overflow-hidden text-white space-y-5 my-8">
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-800 bg-black">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-display font-bold text-lg text-white">FasReach SMS Gateway Settings</h2>
              <p className="text-xs text-gold-500 font-mono">Official FasReach API (https://www.fasreach.com)</p>
            </div>
          </div>
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    placeholder="bms_live_1785502841008_np14a00zkx"
                ...
                <div>
                  ...
                  <p className="text-[11px] text-gray-400 mt-1">
                    Max 11 characters (e.g. JNJVINTAGE)
                  </p>
                </div>
                ...
                <div className="pt-2 flex justify-end">
                  ...
                  >
                    <FiCheck size={14} /> {saveMutation.isPending ? 'Saving...' : 'Save Settings'}
                  </button>
                </div>
              </>
            )}
